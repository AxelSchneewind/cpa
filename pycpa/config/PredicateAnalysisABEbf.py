from pycpa.analyses import PredAbsABEPrecision, PredAbsABECPA, BlockEncodings
...
def get_cpas(entry_point=None, cfa_roots=None, output_dir=None, **params):
    ...
    precision = PredAbsABEPrecision.from_cfa(cfa_roots, BlockEncodings.is_block_head_bf)
    ...
    return [StackCPA(CompositeCPA([LocationCPA(entry_point), PredAbsABECPA(precision, BlockEncodings.is_block_head_bf)]))]
